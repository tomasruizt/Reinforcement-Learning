...
class DiscreteEpisode:
    """
    An episode describes a single interaction of the Agent and the
    Environment. It contains all the information required by learning
    algorithms. It has a starting state, the Agent's action, the
    corresponding reward and the end state the action lead the Agent to.
    This Episode works with discrete states and actions.
    """
